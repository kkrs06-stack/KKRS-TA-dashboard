...
# --- Silence warnings and suppress all 3rd party library output globally ---
...
# ----- HEADER: Title (left) and Date (right) -----
...
# ----- STRATEGY BUTTONS on second row -----
    ...
    def card(row, rsi_green=True):
        ...
        return f"""
            <div style="
                ...
                <span style="font-size:0.93em;">Lot: <b>{row['Lot Size']}</b></span><br>
                {rsi_txt}
            </div>
        """
...
elif selected not in ["rsi", "ssstrat"]:
